...
<body>
	<form id="user" name="registerform" action='<c:url value="/regist" />' method="post" onsubmit="return formCheck(this)"> 	
   ...
   <script>
 		if(${not empty param.registerError}) document.querySelector("#msg").innerText='회원가입 실패.';
